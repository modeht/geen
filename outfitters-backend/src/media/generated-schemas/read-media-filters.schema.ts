...
export class ReadMediaFiltersSchemaFilters {
	preference?: ReadPreferenceFiltersSchemaFilters | null | undefined;
...
export const ReadMediaFiltersSchema: v.GenericSchema<ReadMediaFiltersSchemaFilters> =
	v.object({
