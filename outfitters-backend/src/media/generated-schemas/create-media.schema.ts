...
export const CreateMediaSchema = v.pipe(v.object({preference: v.nullish(v.union([v.object({ id: v.number() }), v.object({name: v.nullish(v.string()),
...
user: v.nullish(v.union([v.object({ id: v.number() }), v.object({username: v.nullish(v.string()),
...
brandStoreCover: v.nullish(v.union([v.object({ id: v.number() }), v.object({storeName: v.nullish(v.string()),
...
followingCount: v.nullish(v.number()),
postsCount: v.nullish(v.number())})])),
brandStoreLogo: v.nullish(v.union([v.object({ id: v.number() }), v.object({storeName: v.nullish(v.string()),
brandName: v.nullish(v.string()),
storeBio: v.nullish(v.string()),
website: v.nullish(v.string()),
isPublished: v.boolean(),
...
iconId: v.number()})])),
postThumbnail: v.nullish(v.union([v.object({ id: v.number() }), v.object({caption: v.nullish(v.string()),
postedById: v.number(),
...
isSaved: v.boolean()})])),
productVariant: v.nullish(v.union([v.object({ id: v.number() }), v.object({isArchived: v.boolean(),
stock: v.number(),
price: v.nullish(v.number()),
lastStockUpdate: v.nullish(v.pipe(v.string('Invalid type: Expected ISO timestamp string'), v.isoTimestamp())),
sku: v.nullish(v.string()),
mainProductId: v.nullish(v.number())})])),
message: v.nullish(v.union([v.object({ id: v.number() }), v.object({readAt: v.pipe(v.string('Invalid type: Expected ISO timestamp string'), v.isoTimestamp()),
...
taggedUsersCount: v.number(),
isLiked: v.optional(v.boolean())})])),
review: v.nullish(v.union([v.object({ id: v.number() }), v.object({stars: v.nullish(v.number()),
...
height: v.nullish(v.number())}),v.metadata({[modelSymbol]: 'MediaEntity',
