...
export const UpdateNotificationSchema = v.pipe(v.object({type: v.optional(v.enum(NotificationType)),
...
productId: v.optional(v.number())}),v.metadata({[modelSymbol]: 'NotificationEntity',
user: 'UserEntity',
