...
export class NotificationController {
	...
	async create(@MoBody(CreateNotificationSchema) body: TCreateNotificationSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdateNotificationSchema) body: TUpdateNotificationSchemaOutput) {
	...
	async read(@MoQuery(ReadNotificationSchema) query: TReadNotificationSchemaOutput) {
