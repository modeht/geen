...
export class CollaborationController {
  ...
  constructor(private service: CollaborationService){}
			...
			async create(
				@MoBody(CreateCollaborationSchema) body: TCreateCollaborationSchemaOutput,
			) {
			...
			async update(
				@Param('id') id: string,
				@MoBody(UpdateCollaborationSchema) body: TUpdateCollaborationSchemaOutput,
			) {
			...
			async read(
				@MoQuery(ReadCollaborationSchema) query: TReadCollaborationSchemaOutput,
			) {
