...
export class ProductOptionValueController {
	...
	async create(@MoBody(CreateProductOptionValueSchema) body: TCreateProductOptionValueSchemaOutput) {
	...
	async read(@MoQuery(ReadProductOptionValueSchema) query: TReadProductOptionValueSchemaOutput) {
