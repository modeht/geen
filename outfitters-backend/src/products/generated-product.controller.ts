...
export class ProductController {
	...
	async create(@MoBody(CreateProductSchema) body: TCreateProductSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdateProductSchema) body: TUpdateProductSchemaOutput) {
	...
	async read(@MoQuery(ReadProductSchema) query: TReadProductSchemaOutput) {
