...
export class ReadProductOptionOrders {name?: OrderDirectionEnum;
...
const ReadProductOptionOrdersSchema: v.GenericSchema<ReadProductOptionOrders> = v.object({name: v.optional(OrderDirectionSchema),
