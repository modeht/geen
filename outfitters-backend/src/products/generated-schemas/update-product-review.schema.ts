...
const UpdateProductReviewSchema = v.pipe(v.object({shopperProfile: v.nullish(v.union([v.object({ id: v.number() }), v.object({username: v.nullish(v.string()),
...
shopperId: v.optional(v.number())}),v.metadata({[modelSymbol]: 'ProductReviewEntity',
