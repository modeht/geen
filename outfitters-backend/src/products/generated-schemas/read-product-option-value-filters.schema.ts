...
export class ReadProductOptionValueFiltersSchemaFilters {
	value?: GenericComparable<'string'> | null;
...
const ReadProductOptionValueFiltersSchema: v.GenericSchema<ReadProductOptionValueFiltersSchemaFilters> = v.object({
	value: v.nullish(comparable('string')),
