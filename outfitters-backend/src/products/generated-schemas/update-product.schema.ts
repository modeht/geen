...
export const UpdateProductSchema = v.pipe(v.object({isArchived: v.optional(v.boolean()),
...
options: v.nullish(v.union([v.array(v.object({id:v.number()})), v.array(v.object({name: v.string(),
productId: v.number()}))])),
ratings: v.nullish(v.union([v.array(v.object({id:v.number()})), v.array(v.object({stars: v.nullish(v.number()),
comment: v.nullish(v.string()),
productId: v.number(),
shopperId: v.number()}))])),
taggedIn: v.nullish(v.union([v.array(v.object({id:v.number()})), v.array(v.object({productId: v.nullish(v.number()),
postId: v.nullish(v.number()),
storyId: v.nullish(v.number()),
affiliationLinkId: v.nullish(v.number())}))])),
affiliationLinks: v.nullish(v.union([v.array(v.object({id:v.number()})), v.array(v.object({isDisabled: v.boolean(),
url: v.string(),
productId: v.number(),
shopperId: v.number()}))])),
...
category: v.nullish(v.union([v.object({ id: v.number() }), v.object({name: v.string(),
isArchived: v.boolean(),
superCategoryId: v.nullish(v.number())})])),
subCategory: v.nullish(v.union([v.object({ id: v.number() }), v.object({name: v.string(),
isArchived: v.boolean(),
superCategoryId: v.nullish(v.number())})])),
collections: v.nullish(v.union([v.array(v.object({name: v.nullish(v.string()),
...
promotions: v.nullish(v.union([v.array(v.object({title: v.string(),
...
brandId: v.number()}))])),
promoCodes: v.nullish(v.union([v.array(v.object({deletedAt: v.pipe(v.string('Invalid type: Expected ISO timestamp string'), v.isoTimestamp()),
code: v.string(),
title: v.string(),
minPurchaseAmount: v.nullish(v.number()),
...
isSaved: v.optional(v.boolean())}),v.metadata({[modelSymbol]: 'ProductEntity',
media: 'MediaEntity',
