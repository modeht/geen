...
export class ReadProductOptionValueOrders {
...
const ReadProductOptionValueOrdersSchema: v.GenericSchema<ReadProductOptionValueOrders> = v.object({
	value: v.optional(OrderDirectionSchema),
