...
import {
	ReadProductFiltersSchema,
	ReadProductFiltersSchemaFilters,
} from './read-product-filters.schema';
import {
	ReadPostFiltersSchema,
	ReadPostFiltersSchemaFilters,
} from '../../posts/generated-schemas/read-post-filters.schema';
import {
	ReadStoryFiltersSchema,
	ReadStoryFiltersSchemaFilters,
} from '../../stories/generated-schemas/read-story-filters.schema';
import {
	ReadAffiliationLinkFiltersSchema,
	ReadAffiliationLinkFiltersSchemaFilters,
} from '../../affiliation-links/generated-schemas/read-affiliation-link-filters.schema';

export class ReadTaggedProductFiltersSchemaFilters {
...
export const ReadTaggedProductFiltersSchema: v.GenericSchema<ReadTaggedProductFiltersSchemaFilters> =
	v.object({
...
export type TReadTaggedProductFiltersSchemaOutput = v.InferOutput<
	typeof ReadTaggedProductFiltersSchema
>;
export type TReadTaggedProductFiltersSchemaInput = v.InferInput<
	typeof ReadTaggedProductFiltersSchema
>;
