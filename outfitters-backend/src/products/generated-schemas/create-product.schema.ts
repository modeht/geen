...
options: v.nullish(v.union([v.array(v.number()), v.array(v.object({name: v.string(),
productId: v.number()}))])),
ratings: v.nullish(v.union([v.array(v.number()), v.array(v.object({stars: v.nullish(v.number()),
comment: v.nullish(v.string()),
productId: v.number(),
shopperId: v.number()}))])),
taggedIn: v.nullish(v.union([v.array(v.number()), v.array(v.object({productId: v.nullish(v.number()),
...
subCategory: v.nullish(v.union([v.number(), v.object({name: v.string(),
isArchived: v.boolean(),
superCategoryId: v.nullish(v.number())})])),
collections: v.nullish(v.union([v.array(v.number()), v.array(v.object({name: v.nullish(v.string()),
isFeatured: v.boolean(),
isPublic: v.boolean(),
brandId: v.nullish(v.number())}))])),
carts: v.nullish(v.union([v.array(v.number()), v.array(v.object({quantity: v.nullish(v.number()),
cartId: v.number(),
productId: v.number(),
variantId: v.number(),
...
savedInCollections: v.nullish(v.union([v.array(v.number()), v.array(v.object({savedCollectionId: v.number(),
productId: v.number(),
postId: v.number(),
userId: v.number()}))])),
brandId: v.nullish(v.number()),
...
isSaved: v.boolean()}),v.metadata({media: 'MediaEntity',
...
export type TCreateProductSchema = v.InferInput<typeof CreateProductSchema>
