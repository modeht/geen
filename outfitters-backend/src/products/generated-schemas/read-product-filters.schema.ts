...
} from './read-product-variant-filters.schema';
import ReadProductOptionFiltersSchema, {
	ReadProductOptionFiltersSchemaFilters,
} from './read-product-option-filters.schema';
import ReadProductReviewFiltersSchema, {
	ReadProductReviewFiltersSchemaFilters,
} from './read-product-review-filters.schema';
import ReadTaggedProductFiltersSchema, {
	ReadTaggedProductFiltersSchemaFilters,
} from './read-tagged-product-filters.schema';
...
export class ReadProductFiltersSchemaFilters {
...
const ReadProductFiltersSchema: v.GenericSchema<ReadProductFiltersSchemaFilters> = v.object({
