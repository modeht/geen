...
export class TaggedProductController {
	...
	async create(@MoBody(CreateTaggedProductSchema) body: TCreateTaggedProductSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdateTaggedProductSchema) body: TUpdateTaggedProductSchemaOutput) {
	...
	async read(@MoQuery(ReadTaggedProductSchema) query: TReadTaggedProductSchemaOutput) {
