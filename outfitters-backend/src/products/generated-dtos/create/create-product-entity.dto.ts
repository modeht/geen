...
import { AddProductEntityMediaEntityDto } from '../../../media/generated-dtos/create/create-product-entity-media-entity.dto';
import { AddProductEntityProductVariantEntityDto } from '../../generated-dtos/create/create-product-entity-product-variant-entity.dto';
import { AddProductEntityProductOptionEntityDto } from '../../generated-dtos/create/create-product-entity-product-option-entity.dto';
import { AddProductEntityProductReviewEntityDto } from '../../generated-dtos/create/create-product-entity-product-review-entity.dto';
import { AddProductEntityTaggedProductEntityDto } from '../../generated-dtos/create/create-product-entity-tagged-product-entity.dto';
import { AddProductEntityAffiliationLinkEntityDto } from '../../../affiliation-links/generated-dtos/create/create-product-entity-affiliation-link-entity.dto';
import { AddProductEntityNotificationEntityDto } from '../../../notifications/generated-dtos/create/create-product-entity-notification-entity.dto';
import { AddProductEntityOrderItemEntityDto } from '../../../orders/generated-dtos/create/create-product-entity-order-item-entity.dto';
import { AddProductEntityMessageEntityDto } from '../../../messages/generated-dtos/create/create-product-entity-message-entity.dto';
import { AddProductEntityBrandProfileEntityDto } from '../../../users/generated-dtos/create/create-product-entity-brand-profile-entity.dto';
import { AddProductEntityCategoryEntityDto } from '../../../categories/generated-dtos/create/create-product-entity-category-entity.dto';
import { AddProductEntityCollectionEntityDto } from '../../../collections/generated-dtos/create/create-product-entity-collection-entity.dto';
import { AddProductEntityCartItemsEntityDto } from '../../../carts/generated-dtos/create/create-product-entity-cart-items-entity.dto';
import { AddProductEntityPromotionEntityDto } from '../../../promotions/generated-dtos/create/create-product-entity-promotion-entity.dto';
import { AddProductEntityPromoCodeEntityDto } from '../../../promotions/generated-dtos/create/create-product-entity-promo-code-entity.dto';
import { AddProductEntitySavedCollectionItemEntityDto } from '../../../saved-collections/generated-dtos/create/create-product-entity-saved-collection-item-entity.dto';
