...
export class ReadRecentSearchesOrders {keyword?: OrderDirectionEnum;
mode?: searchMode | null;
user?: ReadUserOrders | OrderDirectionEnum;
userId?: OrderDirectionEnum}

const ReadRecentSearchesOrdersSchema: v.GenericSchema<ReadRecentSearchesOrders> = v.object({keyword: v.optional(OrderDirectionSchema),
