...
export class ReadRecentSearchesFiltersSchemaFilters {
	keyword?: GenericComparable<'string'> | null;
	mode?: searchMode | null;
	user?: ReadUserFiltersSchemaFilters | null;
	userId?: GenericComparable<'number'> | null;
}

const ReadRecentSearchesFiltersSchema: v.GenericSchema<ReadRecentSearchesFiltersSchemaFilters> = v.object({
	keyword: v.nullish(comparable('string')),
