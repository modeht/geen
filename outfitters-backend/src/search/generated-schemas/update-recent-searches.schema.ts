...
export const UpdateRecentSearchesSchema = v.pipe(v.object({keyword: v.nullish(v.string()),
...
userId: v.optional(v.number())}),v.metadata({[modelSymbol]: 'RecentSearchesEntity',
user: 'UserEntity'}))
