...
export class RecentSearchesController {
  ...
  constructor(private service: RecentSearchesService){}
			...
			async create(
				@MoBody(CreateRecentSearchesSchema) body: TCreateRecentSearchesSchemaOutput,
			) {
			...
			async update(
				@Param('id') id: string,
				@MoBody(UpdateRecentSearchesSchema) body: TUpdateRecentSearchesSchemaOutput,
			) {
			...
			async read(
				@MoQuery(ReadRecentSearchesSchema) query: TReadRecentSearchesSchemaOutput,
			) {
