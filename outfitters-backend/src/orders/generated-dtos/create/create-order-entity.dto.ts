import { IsOptional, IsEnum, IsNumber, ValidateNested, IsArray } from "class-validator";
...
import { AddOrderEntityCartEntityDto } from '../../../carts/generated-dtos/create/create-order-entity-cart-entity.dto';
import { AddOrderEntityBrandOrderEntityDto } from '../../generated-dtos/create/create-order-entity-brand-order-entity.dto';
import { AddOrderEntityShippingAddressEntityDto } from '../../../users/generated-dtos/create/create-order-entity-shipping-address-entity.dto';
import { AddOrderEntityShopperProfileEntityDto } from '../../../users/generated-dtos/create/create-order-entity-shopper-profile-entity.dto';
