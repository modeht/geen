...
import ReadBrandOrderFiltersSchema, {
	ReadBrandOrderFiltersSchemaFilters,
} from './read-brand-order-filters.schema';
import ReadShippingAddressFiltersSchema, {
	ReadShippingAddressFiltersSchemaFilters,
} from '../../users/generated-schemas/read-shipping-address-filters.schema';
...
export class ReadOrderFiltersSchemaFilters {
...
const ReadOrderFiltersSchema: v.GenericSchema<ReadOrderFiltersSchemaFilters> = v.object({
