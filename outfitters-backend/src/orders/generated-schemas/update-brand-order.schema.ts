...
export const UpdateBrandOrderSchema = v.pipe(v.object({status: v.optional(v.enum(OrderStatusEnum)),
...
brandId: v.optional(v.number())}),v.metadata({[modelSymbol]: 'BrandOrderEntity',
