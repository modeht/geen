...
import ReadShippingAddressOrdersSchema, {
	ReadShippingAddressOrders,
} from '../../users/generated-schemas/read-shipping-address-orders.schema';
...
const ReadOrderOrdersSchema: v.GenericSchema<ReadOrderOrders> = v.object({
