...
brands: v.nullish(v.union([v.array(v.object({id:v.number()})), v.array(v.object({storeName: v.nullish(v.string()),
...
iconId: v.number()}),v.metadata({[modelSymbol]: 'CountryEntity',
icon: 'MediaEntity',
