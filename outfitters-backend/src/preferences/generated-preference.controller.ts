...
export class PreferenceController {
	...
	async create(@MoBody(CreatePreferenceSchema) body: TCreatePreferenceSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdatePreferenceSchema) body: TUpdatePreferenceSchemaOutput) {
	...
	async read(@MoQuery(ReadPreferenceSchema) query: TReadPreferenceSchemaOutput) {
