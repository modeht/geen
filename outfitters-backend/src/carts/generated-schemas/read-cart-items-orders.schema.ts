...
export class ReadCartItemsOrders {
	quantity?: OrderDirectionEnum | undefined;
...
export const ReadCartItemsOrdersSchema: v.GenericSchema<ReadCartItemsOrders> = v.object({
	quantity: v.undefinedable(OrderDirectionSchema),
	cart: v.undefinedable(
		v.union([OrderDirectionSchema, v.lazy(() => ReadCartOrdersSchema)]),
	),
	product: v.undefinedable(
		v.union([OrderDirectionSchema, v.lazy(() => ReadProductOrdersSchema)]),
	),
	variant: v.undefinedable(
		v.union([OrderDirectionSchema, v.lazy(() => ReadProductVariantOrdersSchema)]),
	),
	affiliationLink: v.undefinedable(
		v.union([OrderDirectionSchema, v.lazy(() => ReadAffiliationLinkOrdersSchema)]),
	),
...
export type TReadCartItemsOrdersSchemaOutput = v.InferOutput<
	typeof ReadCartItemsOrdersSchema
>;
export type TReadCartItemsOrdersSchemaInput = v.InferInput<
	typeof ReadCartItemsOrdersSchema
>;
