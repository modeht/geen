...
import { ReadCartItemsRelationsSchema, ReadCartItemsRelationsSchemaRelations } from './read-cart-items-relations.schema'
...
export class ReadCartRelationsSchemaRelations {order?: ReadOrderRelationsSchemaRelations | boolean | null | undefined;
...
export const ReadCartRelationsSchema: v.GenericSchema<ReadCartRelationsSchemaRelations> = v.object({order: v.nullish(v.union([v.boolean(), v.lazy(() => ReadOrderRelationsSchema)])),
