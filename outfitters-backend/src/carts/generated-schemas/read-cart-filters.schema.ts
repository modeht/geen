...
export class ReadCartFiltersSchemaFilters {order?: ReadOrderFiltersSchemaFilters | null | undefined;
...
export const ReadCartFiltersSchema: v.GenericSchema<ReadCartFiltersSchemaFilters> = v.object({order: v.nullish(v.lazy(() => ReadOrderFiltersSchema)),
...
export type TReadCartSchemaOutput = v.InferOutput<typeof ReadCartFiltersSchema>;
export type TReadCartSchemaInput = v.InferInput<typeof ReadCartFiltersSchema>;
