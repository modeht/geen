...
import { CartStatus } from '<<pathToOriginal>>';

export const CreateCartSchema = v.pipe(v.object({order: v.nullish(v.union([v.number(), v.object({totalSalePrice: v.nullish(v.number()),
...
export type TCreateCartSchema = v.InferInput<typeof CreateCartSchema>
