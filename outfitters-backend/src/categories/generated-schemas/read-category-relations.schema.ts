...
import { ReadSeasonalPromotionRelationsSchema, ReadSeasonalPromotionRelationsSchemaRelations } from '../../promotions/generated-schemas/read-seasonal-promotion-relations.schema'

export class ReadCategoryRelationsSchemaRelations {media?: ReadMediaRelationsSchemaRelations | boolean | null | undefined;
...
categorybrandProfiles?: ReadBrandProfileRelationsSchemaRelations | boolean | null | undefined;
subCategoriesBrandProfiles?: ReadBrandProfileRelationsSchemaRelations | boolean | null | undefined;
seasonalPromotions?: ReadSeasonalPromotionRelationsSchemaRelations | boolean | null | undefined}

export const ReadCategoryRelationsSchema: v.GenericSchema<ReadCategoryRelationsSchemaRelations> = v.object({media: v.nullish(v.union([v.boolean(), v.lazy(() => ReadMediaRelationsSchema)])),
