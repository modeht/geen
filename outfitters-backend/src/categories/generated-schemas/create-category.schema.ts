...
superCategory: v.nullish(v.union([v.object({ id: v.number() }), v.object({name: v.string(),
isArchived: v.boolean(),
superCategoryId: v.nullish(v.number())})])),
superCategoryId: v.nullish(v.number()),
...
isSaved: v.boolean()}))])),
categorybrandProfiles: v.nullish(v.union([v.array(v.object({storeName: v.nullish(v.string()),
...
subCategoriesBrandProfiles: v.nullish(v.union([v.array(v.object({storeName: v.nullish(v.string()),
brandName: v.nullish(v.string()),
storeBio: v.nullish(v.string()),
website: v.nullish(v.string()),
isPublished: v.boolean(),
...
followingCount: v.nullish(v.number()),
postsCount: v.nullish(v.number())}))])),
seasonalPromotions: v.nullish(v.union([v.array(v.object({title: v.string(),
...
status: v.enum(PromotionStatusEnum)}))]))}),v.metadata({[modelSymbol]: 'CategoryEntity',
media: 'MediaEntity',
