...
export const CreateCategorySchema = v.pipe(v.object({name: v.string(),
isArchived: v.boolean(),
media: v.union([v.number(), v.object({mimetype: v.nullish(v.string()),
...
superCategory: v.nullish(v.union([v.number(), v.object({name: v.string(),
isArchived: v.boolean(),
superCategoryId: v.nullish(v.number())})])),
superCategoryId: v.nullish(v.number()),
...
isSaved: v.boolean()}))])),
categorybrandProfiles: v.nullish(v.union([v.array(v.number()), v.array(v.object({storeName: v.nullish(v.string()),
...
subCategoriesBrandProfiles: v.nullish(v.union([v.array(v.number()), v.array(v.object({storeName: v.nullish(v.string()),
brandName: v.nullish(v.string()),
storeBio: v.nullish(v.string()),
website: v.nullish(v.string()),
isPublished: v.boolean(),
...
followingCount: v.nullish(v.number()),
postsCount: v.nullish(v.number())}))])),
seasonalPromotions: v.nullish(v.union([v.array(v.number()), v.array(v.object({title: v.string(),
start: v.pipe(v.string('Invalid type: Expected ISO timestamp string'), v.isoTimestamp()),
end: v.pipe(v.string('Invalid type: Expected ISO timestamp string'), v.isoTimestamp())}))]))}),v.metadata({media: 'MediaEntity',
