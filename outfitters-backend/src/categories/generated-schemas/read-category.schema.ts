...
import { ReadSeasonalPromotionSchema, ReadSeasonalPromotionSchemaFilters } from '../../promotions/generated-schemas/read-seasonal-promotion.schema'

export class ReadCategorySchemaFilters {name?: GenericComparable<"string"> | null | undefined;
...
export const ReadCategorySchema: v.GenericSchema<ReadCategorySchemaFilters> = v.object({name: v.nullish(comparable("string")),
