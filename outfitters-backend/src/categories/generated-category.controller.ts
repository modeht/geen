...
export class CategoryController {
  ...
  constructor(private service: CategoryService){}
			...
			async create(
				@MoBody(CreateCategorySchema) body: TCreateCategorySchemaOutput,
			) {
			...
			async update(
				@Param('id') id: string,
				@MoBody(UpdateCategorySchema) body: TUpdateCategorySchemaOutput,
			) {
			...
			async read(
				@MoQuery(ReadCategorySchema) query: TReadCategorySchemaOutput,
			) {
