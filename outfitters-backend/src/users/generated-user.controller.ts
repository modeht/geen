...
export class UserController {
	...
	async create(@MoBody(CreateUserSchema) body: TCreateUserSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdateUserSchema) body: TUpdateUserSchemaOutput) {
	...
	async read(@MoQuery(ReadUserSchema) query: TReadUserSchemaOutput) {
