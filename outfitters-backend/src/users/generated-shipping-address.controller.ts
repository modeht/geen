...
export class ShippingAddressController {
	...
	async create(@MoBody(CreateShippingAddressSchema) body: TCreateShippingAddressSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdateShippingAddressSchema) body: TUpdateShippingAddressSchemaOutput) {
	...
	async read(@MoQuery(ReadShippingAddressSchema) query: TReadShippingAddressSchemaOutput) {
