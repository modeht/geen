...
import { AccountStatus } from '<<pathToOriginal>>';

export const CreateUserSchema = v.pipe(v.object({email: v.nullish(v.string()),
...
isLiked: v.undefinedable(v.boolean()),
isViewed: v.undefinedable(v.boolean())}))])),
following: v.nullish(v.union([v.array(v.number()), v.array(v.object({email: v.nullish(v.string()),
phone: v.nullish(v.string()),
password: v.nullish(v.string()),
firebaseId: v.nullish(v.string()),
emailVerified: v.nullish(v.boolean()),
...
followersCount: v.nullish(v.number())}))])),
follows: v.nullish(v.union([v.array(v.number()), v.array(v.object({email: v.nullish(v.string()),
phone: v.nullish(v.string()),
password: v.nullish(v.string()),
firebaseId: v.nullish(v.string()),
emailVerified: v.nullish(v.boolean()),
...
isBlockedBy: v.nullish(v.boolean()),
followersCount: v.nullish(v.number())}))])),
blockedBy: v.nullish(v.union([v.array(v.number()), v.array(v.object({email: v.nullish(v.string()),
phone: v.nullish(v.string()),
password: v.nullish(v.string()),
firebaseId: v.nullish(v.string()),
emailVerified: v.nullish(v.boolean()),
...
isBlockedBy: v.nullish(v.boolean()),
followersCount: v.nullish(v.number())}))])),
blockedUsers: v.nullish(v.union([v.array(v.number()), v.array(v.object({email: v.nullish(v.string()),
phone: v.nullish(v.string()),
password: v.nullish(v.string()),
firebaseId: v.nullish(v.string()),
emailVerified: v.nullish(v.boolean()),
...
export type TCreateUserSchema = v.InferInput<typeof CreateUserSchema>
