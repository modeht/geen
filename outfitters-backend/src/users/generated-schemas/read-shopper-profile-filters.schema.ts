...
import ReadShippingAddressFiltersSchema, {
	ReadShippingAddressFiltersSchemaFilters,
} from './read-shipping-address-filters.schema';
...
import ReadOrderFiltersSchema, {
	ReadOrderFiltersSchemaFilters,
} from '../../orders/generated-schemas/read-order-filters.schema';
...
import ReadAffiliationLinkFiltersSchema, {
...
export class ReadShopperProfileFiltersSchemaFilters {
...
const ReadShopperProfileFiltersSchema: v.GenericSchema<ReadShopperProfileFiltersSchemaFilters> = v.object({
