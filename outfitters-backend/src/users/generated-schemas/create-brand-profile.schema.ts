...
categories: v.nullish(v.union([v.array(v.object({id:v.number()})), v.array(v.object({name: v.string(),
...
isArchived: v.boolean(),
superCategoryId: v.nullish(v.number())}))])),
countries: v.nullish(v.union([v.array(v.object({id:v.number()})), v.array(v.object({name: v.string(),
code: v.string(),
dialCode: v.string(),
