...
logo: v.nullish(v.union([v.number(), v.object({mimetype: v.nullish(v.string()),
...
brandOrders: v.nullish(v.union([v.array(v.number()), v.array(v.object({status: v.enum(OrderStatusEnum),
...
collaborations: v.nullish(v.union([v.array(v.number()), v.array(v.object({status: v.enum(CollaborationStatusEnum),
brandId: v.nullish(v.number()),
shopperId: v.nullish(v.number())}))])),
categories: v.nullish(v.union([v.array(v.number()), v.array(v.object({name: v.string(),
isArchived: v.boolean(),
superCategoryId: v.nullish(v.number())}))])),
subCategories: v.nullish(v.union([v.array(v.number()), v.array(v.object({name: v.string(),
isArchived: v.boolean(),
superCategoryId: v.nullish(v.number())}))])),
countries: v.nullish(v.union([v.array(v.number()), v.array(v.object({name: v.string(),
code: v.string(),
dialCode: v.string(),
...
postsCount: v.nullish(v.number())}),v.metadata({user: 'UserEntity',
logo: 'MediaEntity',
cover: 'MediaEntity',
