...
import ReadBrandOrderOrdersSchema, {
	ReadBrandOrderOrders,
} from '../../orders/generated-schemas/read-brand-order-orders.schema';
...
export class ReadBrandProfileOrders {
	storeName?: OrderDirectionEnum;
...
const ReadBrandProfileOrdersSchema: v.GenericSchema<ReadBrandProfileOrders> = v.object({
	storeName: v.optional(OrderDirectionSchema),
