...
} from '../../orders/generated-schemas/read-brand-order-filters.schema';
...
export class ReadBrandProfileFiltersSchemaFilters {
	storeName?: GenericComparable<'string'> | null;
...
const ReadBrandProfileFiltersSchema: v.GenericSchema<ReadBrandProfileFiltersSchemaFilters> = v.object({
	storeName: v.nullish(comparable('string')),
