...
export class ReadShippingAddressFiltersSchemaFilters {
...
const ReadShippingAddressFiltersSchema: v.GenericSchema<ReadShippingAddressFiltersSchemaFilters> = v.object({
