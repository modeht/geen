...
export class SeasonalPromotionController {
	...
	async create(@MoBody(CreateSeasonalPromotionSchema) body: TCreateSeasonalPromotionSchemaOutput) {
	...
	async read(@MoQuery(ReadSeasonalPromotionSchema) query: TReadSeasonalPromotionSchemaOutput) {
