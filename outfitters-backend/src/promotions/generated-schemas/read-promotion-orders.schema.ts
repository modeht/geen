...
} from './read-seasonal-promotion-orders.schema';
...
export class ReadPromotionOrders {
...
const ReadPromotionOrdersSchema: v.GenericSchema<ReadPromotionOrders> = v.object({
