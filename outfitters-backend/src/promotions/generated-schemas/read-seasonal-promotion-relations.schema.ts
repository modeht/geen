...
import { ReadPromotionRelationsSchema, ReadPromotionRelationsSchemaRelations } from './read-promotion-relations.schema'
...
export class ReadSeasonalPromotionRelationsSchemaRelations {promotions?: ReadPromotionRelationsSchemaRelations | boolean | null | undefined;
subCategories?: ReadCategoryRelationsSchemaRelations | boolean | null | undefined}

export const ReadSeasonalPromotionRelationsSchema: v.GenericSchema<ReadSeasonalPromotionRelationsSchemaRelations> = v.object({promotions: v.nullish(v.union([v.boolean(), v.lazy(() => ReadPromotionRelationsSchema)])),
