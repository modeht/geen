...
import { ReadSeasonalPromotionRelationsSchema, ReadSeasonalPromotionRelationsSchemaRelations } from './read-seasonal-promotion-relations.schema'
...
export class ReadPromotionRelationsSchemaRelations {notifications?: ReadNotificationRelationsSchemaRelations | boolean | null | undefined;
brand?: ReadBrandProfileRelationsSchemaRelations | boolean | null | undefined;
seasonalPromotion?: ReadSeasonalPromotionRelationsSchemaRelations | boolean | null | undefined;
...
export const ReadPromotionRelationsSchema: v.GenericSchema<ReadPromotionRelationsSchemaRelations> = v.object({notifications: v.nullish(v.union([v.boolean(), v.lazy(() => ReadNotificationRelationsSchema)])),
