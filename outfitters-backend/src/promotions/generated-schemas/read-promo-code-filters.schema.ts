...
export class ReadPromoCodeFiltersSchemaFilters {
	deletedAt?: GenericComparable<'date'> | null | undefined;
...
export const ReadPromoCodeFiltersSchema: v.GenericSchema<ReadPromoCodeFiltersSchemaFilters> =
	v.object({
...
export type TReadPromoCodeFiltersSchemaOutput = v.InferOutput<
	typeof ReadPromoCodeFiltersSchema
>;
export type TReadPromoCodeFiltersSchemaInput = v.InferInput<
	typeof ReadPromoCodeFiltersSchema
>;
