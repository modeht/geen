...
export class PostLikesController {
	...
	async create(@MoBody(CreatePostLikesSchema) body: TCreatePostLikesSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdatePostLikesSchema) body: TUpdatePostLikesSchemaOutput) {
	...
	async read(@MoQuery(ReadPostLikesSchema) query: TReadPostLikesSchemaOutput) {
