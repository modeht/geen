...
postedById: v.number(),
taggedUsers: v.nullish(v.union([v.array(v.object({id:v.number()})), v.array(v.object({status: v.enum(AccountStatus),
email: v.nullish(v.string()),
phone: v.nullish(v.string()),
password: v.nullish(v.string()),
firebaseId: v.nullish(v.string()),
...
isLiked: v.undefinedable(v.boolean())}),v.metadata({[modelSymbol]: 'PostEntity',
media: 'MediaEntity',
