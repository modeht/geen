...
export const CreatePostSchema = v.pipe(v.object({caption: v.nullish(v.string()),
...
thumbnail: v.nullish(v.union([v.number(), v.object({mimetype: v.nullish(v.string()),
url: v.nullish(v.string()),
size: v.nullish(v.number()),
width: v.nullish(v.number()),
height: v.nullish(v.number())})])),
...
postedBy: v.nullish(v.union([v.number(), v.object({status: v.enum(AccountStatus),
...
postedById: v.number(),
taggedUsers: v.nullish(v.union([v.array(v.number()), v.array(v.object({status: v.enum(AccountStatus),
email: v.nullish(v.string()),
phone: v.nullish(v.string()),
password: v.nullish(v.string()),
firebaseId: v.nullish(v.string()),
...
isLiked: v.undefinedable(v.boolean())}),v.metadata({media: 'MediaEntity',
