...
export class SavedCollectionItemController {
	...
	async create(@MoBody(CreateSavedCollectionItemSchema) body: TCreateSavedCollectionItemSchemaOutput) {
	...
	async read(@MoQuery(ReadSavedCollectionItemSchema) query: TReadSavedCollectionItemSchemaOutput) {
