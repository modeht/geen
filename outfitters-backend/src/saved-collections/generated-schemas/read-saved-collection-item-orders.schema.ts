...
const ReadSavedCollectionItemOrdersSchema: v.GenericSchema<ReadSavedCollectionItemOrders> = v.object({savedCollection: v.undefinedable(v.union([OrderDirectionSchema, v.lazy(() => ReadSavedCollectionOrdersSchema)])),
