...
export class ReadSavedCollectionItemOrders {
	savedCollection?: ReadSavedCollectionOrders | OrderDirectionEnum;
...
const ReadSavedCollectionItemOrdersSchema: v.GenericSchema<ReadSavedCollectionItemOrders> = v.object({
	savedCollection: v.optional(v.union([OrderDirectionSchema, v.lazy(() => ReadSavedCollectionOrdersSchema)])),
