...
} from './read-saved-collection-relations.schema';
...
export class ReadSavedCollectionItemRelations {
	savedCollection?: ReadSavedCollectionRelations | string | boolean;
	product?: ReadProductRelations | string | boolean;
	post?: ReadPostRelations | string | boolean;
}

const ReadSavedCollectionItemRelationsSchema: v.GenericSchema<ReadSavedCollectionItemRelations> = v.object({
	savedCollection: v.optional(
		v.union([
			v.pipe(
...
export type TReadSavedCollectionItemRelationsSchemaOutput = v.InferOutput<
	typeof ReadSavedCollectionItemRelationsSchema
>;
