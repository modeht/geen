...
export class StoryController {
	...
	async create(@MoBody(CreateStorySchema) body: TCreateStorySchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdateStorySchema) body: TUpdateStorySchemaOutput) {
	...
	async read(@MoQuery(ReadStorySchema) query: TReadStorySchemaOutput) {
