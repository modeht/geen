...
export class ReadStoryOrders {
	background?: OrderDirectionEnum;
...
const ReadStoryOrdersSchema: v.GenericSchema<ReadStoryOrders> = v.object({
	background: v.optional(OrderDirectionSchema),
