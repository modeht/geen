...
export class ReadStoryRelations {media?: ReadMediaRelations | string | boolean;
...
const ReadStoryRelationsSchema: v.GenericSchema<ReadStoryRelations> = v.object({media: v.optional(v.union([v.pipe(
