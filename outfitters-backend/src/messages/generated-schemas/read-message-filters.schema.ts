...
export class ReadMessageFiltersSchemaFilters {readAt?: GenericComparable<"date"> | null;
...
const ReadMessageFiltersSchema: v.GenericSchema<ReadMessageFiltersSchemaFilters> = v.object({readAt: v.nullish(comparable("date")),
