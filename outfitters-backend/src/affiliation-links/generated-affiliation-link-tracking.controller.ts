...
export class AffiliationLinkTrackingController {
	...
	async create(
		@MoBody(CreateAffiliationLinkTrackingSchema)
		body: TCreateAffiliationLinkTrackingSchemaOutput,
	) {
	...
	async update(
		@Param('id') id: string,
		@MoBody(UpdateAffiliationLinkTrackingSchema)
		body: TUpdateAffiliationLinkTrackingSchemaOutput,
	) {
	...
	async read(
		@MoQuery(ReadAffiliationLinkTrackingSchema)
		query: TReadAffiliationLinkTrackingSchemaOutput,
	) {
