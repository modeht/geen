...
export class ReadAffiliationLinkFiltersSchemaFilters {
	isDisabled?: GenericComparable<'bool'> | null | undefined;
...
export const ReadAffiliationLinkFiltersSchema: v.GenericSchema<ReadAffiliationLinkFiltersSchemaFilters> =
	v.object({
		...
		affiliationLinkTracking: v.nullish(
			v.lazy(() => ReadAffiliationLinkTrackingFiltersSchema),
		),
...
export type TReadAffiliationLinkFiltersSchemaOutput = v.InferOutput<
	typeof ReadAffiliationLinkFiltersSchema
>;
export type TReadAffiliationLinkFiltersSchemaInput = v.InferInput<
	typeof ReadAffiliationLinkFiltersSchema
>;
