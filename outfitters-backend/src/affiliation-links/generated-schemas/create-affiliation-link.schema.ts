...
export const CreateAffiliationLinkSchema = v.pipe(
	v.object({
...
export type TCreateAffiliationLinkSchemaInput = v.InferInput<
	typeof CreateAffiliationLinkSchema
>;
export type TCreateAffiliationLinkSchemaOutput = v.InferOutput<
	typeof CreateAffiliationLinkSchema
>;
