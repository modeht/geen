...
export class AffiliationLinkController {
	...
	async create(@MoBody(CreateAffiliationLinkSchema) body: TCreateAffiliationLinkSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdateAffiliationLinkSchema) body: TUpdateAffiliationLinkSchemaOutput) {
	...
	async read(@MoQuery(ReadAffiliationLinkSchema) query: TReadAffiliationLinkSchemaOutput) {
