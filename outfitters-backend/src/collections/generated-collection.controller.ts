...
export class CollectionController {
	...
	async create(@MoBody(CreateCollectionSchema) body: TCreateCollectionSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdateCollectionSchema) body: TUpdateCollectionSchemaOutput) {
	...
	async read(@MoQuery(ReadCollectionSchema) query: TReadCollectionSchemaOutput) {
