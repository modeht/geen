...
export class RefundController {
	...
	async create(@MoBody(CreateRefundSchema) body: TCreateRefundSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdateRefundSchema) body: TUpdateRefundSchemaOutput) {
	...
	async read(@MoQuery(ReadRefundSchema) query: TReadRefundSchemaOutput) {
