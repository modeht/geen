...
export class TranslationController {
	...
	async create(@MoBody(CreateTranslationSchema) body: TCreateTranslationSchemaOutput) {
	...
	async update(@Param('id') id: string, @MoBody(UpdateTranslationSchema) body: TUpdateTranslationSchemaOutput) {
	...
	async read(@MoQuery(ReadTranslationSchema) query: TReadTranslationSchemaOutput) {
