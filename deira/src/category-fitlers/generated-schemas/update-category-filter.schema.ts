...
const UpdateCategoryFilterSchema = v.pipe(
	v.object({
...
export default UpdateCategoryFilterSchema;

export type TUpdateCategoryFilterSchemaInput = v.InferInput<typeof UpdateCategoryFilterSchema>;
export type TUpdateCategoryFilterSchemaOutput = v.InferOutput<typeof UpdateCategoryFilterSchema>;
