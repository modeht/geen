...
const UpdateFavoriteSchema = v.pipe(
	v.object({
		ad: v.nullish(
			v.union([
...
export type TUpdateFavoriteSchemaInput = v.InferInput<typeof UpdateFavoriteSchema>;
export type TUpdateFavoriteSchemaOutput = v.InferOutput<typeof UpdateFavoriteSchema>;
