...
const UpdateBannerSchema = v.pipe(
	v.object({
		category: v.nullish(
			v.union([
...
export default UpdateBannerSchema;

export type TUpdateBannerSchemaInput = v.InferInput<typeof UpdateBannerSchema>;
export type TUpdateBannerSchemaOutput = v.InferOutput<typeof UpdateBannerSchema>;
