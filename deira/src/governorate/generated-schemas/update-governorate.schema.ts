...
const UpdateGovernorateSchema = v.pipe(
	v.object({
...
export default UpdateGovernorateSchema;

export type TUpdateGovernorateSchemaInput = v.InferInput<typeof UpdateGovernorateSchema>;
export type TUpdateGovernorateSchemaOutput = v.InferOutput<typeof UpdateGovernorateSchema>;
