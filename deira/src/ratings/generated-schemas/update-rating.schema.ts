...
const UpdateRatingSchema = v.pipe(
	v.object({
...
export default UpdateRatingSchema;

export type TUpdateRatingSchemaInput = v.InferInput<typeof UpdateRatingSchema>;
export type TUpdateRatingSchemaOutput = v.InferOutput<typeof UpdateRatingSchema>;
